...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      if (n > this.slides.lenght) {
        this.slideIndex = 1;
      }

      if (n < 1) {
        this.slideIndex = this.slideIndex.lenght;
      }
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, animate, autolplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, animate, autolplay));
  }
